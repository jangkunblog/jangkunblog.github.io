...
미천한 실력이지만, 한국정보화진흥원에서 운영하는 웹 접근성 연구소(<http://www.wah.or.kr>)에서 기술자문을 하고 있습니다. 자문게시판에 질문을 올리면 답변을 하는 역할입니다.
...
원래 웹 접근성 연구소의 자문글(<http://goo.gl/tPoh0>)에는 '**원**'이라는 표현을 썼는데,
...
다시 '웹 접근성 연구소(<http://www.wah.or.kr>)'과 비교해보겠습니다.
